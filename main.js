...
var $author$project$Railroad$Orientation$Reverse = {$: 'Reverse'};
...
var $author$project$Railroad$sample = function () {
	var td = A3(
		...
		2,
		{from: 1, geometry: $author$project$Railroad$Layout$StraightTrack, to: 3},
		A3(
			$elm$core$Dict$insert,
			1,
			{from: 1, geometry: $author$project$Railroad$Layout$StraightTrack, to: 2},
			$elm$core$Dict$empty));
	var cd = A3(
		$elm$core$Dict$insert,
		3,
			...
			return $elm$core$Maybe$Just(
				{
					...
					trains: _List_fromArray(
						[
							{
							length: 30,
							loc: {orient: $author$project$Railroad$Orientation$Reverse, pos: 50, track: track},
							speed: 11.1,
...
var $author$project$Main$init = function (_v0) {
	...
	return _Utils_Tuple2(
		{frame: 0, initialState: s, isRunning: false, millis: $elm$core$Maybe$Nothing, scale: 1, state: s},
...
var $author$project$Railroad$EmergencyStop = {$: 'EmergencyStop'};
...
var $author$project$Railroad$Layout$Connector = F2(
	function (a, b) {
		return {$: 'Connector', a: a, b: b};
	});
var $author$project$Railroad$Layout$dummyTrackData = {from: 0, geometry: $author$project$Railroad$Layout$StraightTrack, to: 0};
...
var $author$project$Railroad$Layout$getConnectors = function (_v0) {
	...
	return {
		from: A2($author$project$Railroad$Layout$Connector, trackData.from, layout),
		to: A2($author$project$Railroad$Layout$Connector, trackData.to, layout)
	};
};
var $author$project$Railroad$Orientation$Forward = {$: 'Forward'};
			...
			F2(
				function (trackId, trackData) {
					return _Utils_Tuple2(
						...
						_Utils_eq(trackData.from, id) ? $author$project$Railroad$Orientation$Forward : $author$project$Railroad$Orientation$Reverse);
				}),
			A2(
				$elm$core$Dict$filter,
				F2(
					function (_v2, trackData) {
						return _Utils_eq(trackData.from, id) || _Utils_eq(trackData.to, id);
					}),
				trackDict)));
};
...
var $author$project$Railroad$movedTrain = F2(
	function (millis, train) {
		var loc = train.loc;
		var distanceMoved = A2($author$project$Railroad$Orientation$byOrientation, train.loc.orient, (train.speed * millis) / 1000);
			...
			case 'Tick':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							frame: duration,
							millis: $elm$core$Maybe$Just(newMillis),
							state: function () {
								var _v1 = model.state;
								if (_v1.$ === 'Just') {
									var s = _v1.a;
									return model.isRunning ? $elm$core$Maybe$Just(
										A2($author$project$Railroad$moved, duration, s)) : model.state;
								} else {
									return $elm$core$Maybe$Nothing;
								}
							}()
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$core$String$fromFloat(from.x)),
				$elm$svg$Svg$Attributes$y1(
				$elm$core$String$fromFloat(from.y)),
				$elm$svg$Svg$Attributes$x2(
				$elm$core$String$fromFloat(to.x)),
				$elm$svg$Svg$Attributes$y2(
				$elm$core$String$fromFloat(to.y)),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										$elm$core$String$fromInt(
											$author$project$Railroad$Layout$getTrackId(train.loc.track)))
									])),
								A2(
								$elm$html$Html$td,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										A2($myrho$elm_round$Round$round, 1, train.loc.pos))
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										A2($myrho$elm_round$Round$round, 1, train.speed))
									])),
								A2(
								$elm$html$Html$td,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										A2($myrho$elm_round$Round$round, 1, train.length))
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
									...
									[
										...
										_List_fromArray(
											[
												...
												$author$project$Main$scaleTransform(model.scale))
											]),
										function () {
											var _v0 = model.state;
											if (_v0.$ === 'Just') {
												...
												return _List_fromArray(
													[
														...
														A2(
															...
															$author$project$Railroad$Layout$tracks(state.layout))),
														A2(
														$elm$svg$Svg$g,
														_List_Nil,
														A2(
															...
															$author$project$Railroad$Layout$connectors(state.layout))),
														A2(
														$elm$svg$Svg$g,
														_List_Nil,
														A2($elm$core$List$map, $author$project$Main$trainToSvg, state.trains))
													]);
											} else {
												return _List_Nil;
											}
							...
							[
								...
								_List_fromArray(
									[
										...
										if (_v1.$ === 'Just') {
											var stateRR = _v1.a;
											return A2($elm$html$Html$Lazy$lazy, $author$project$Main$viewTrains, stateRR.trains);
										} else {
