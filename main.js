...
var $author$project$Railroad$sample = function () {
	...
	return {
		...
		trains: _List_fromArray(
			[
				{length: 30, orient: $author$project$Railroad$Reverse, pos: 50, speed: 11.1, track: t1}
			])
	};
}();
...
var $author$project$Railroad$movedTrain = F2(
	function (millis, train) {
		return _Utils_update(
			...
			{
				pos: function () {
					var _v0 = train.orient;
					if (_v0.$ === 'Forward') {
						return train.pos + ((train.speed * millis) / 1000);
					} else {
						return train.pos - ((train.speed * millis) / 1000);
					}
				}()
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							state: model.isRunning ? A2($author$project$Railroad$moved, duration, model.state) : model.state
						}),
					$elm$core$Platform$Cmd$none);
			case 'Start':
				return _Utils_Tuple2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$core$String$fromFloat(conn.pos.x)),
				$elm$svg$Svg$Attributes$cy(
				$elm$core$String$fromFloat(conn.pos.y)),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$core$String$fromFloat(track.from.pos.x)),
				$elm$svg$Svg$Attributes$y1(
				$elm$core$String$fromFloat(track.from.pos.y)),
				$elm$svg$Svg$Attributes$x2(
				$elm$core$String$fromFloat(track.to.pos.x)),
				$elm$svg$Svg$Attributes$y2(
				$elm$core$String$fromFloat(track.to.pos.y)),
...
var $author$project$Main$trainSpec = function (train) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(
				'pos: ' + (A2($myrho$elm_round$Round$round, 3, train.pos) + (' m, speed: ' + (A2($myrho$elm_round$Round$round, 3, train.speed) + (' m/s, length: ' + (A2($myrho$elm_round$Round$round, 3, train.length) + ' m'))))))
			]));
};
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $author$project$Main$trainList = function (trains) {
	return A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Main$trainSpec, trains));
};
...
var $author$project$Main$trackOccupancyToSvg = function (occ) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$x1(
				$elm$core$String$fromFloat(occ.track.from.pos.x + ((dx * occ.from) / tl))),
				$elm$svg$Svg$Attributes$y1(
				$elm$core$String$fromFloat(occ.track.from.pos.y + ((dy * occ.from) / tl))),
				$elm$svg$Svg$Attributes$x2(
				$elm$core$String$fromFloat(occ.track.from.pos.x + ((dx * occ.to) / tl))),
				$elm$svg$Svg$Attributes$y2(
				$elm$core$String$fromFloat(occ.track.from.pos.y + ((dy * occ.to) / tl))),
					...
					[
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$svg$Svg$g,
												_List_Nil,
												A2($elm$core$List$map, $author$project$Main$trackToSvg, model.state.layout.tracks)),
												A2(
												$elm$svg$Svg$g,
												_List_Nil,
												A2(
												...
												$elm$svg$Svg$g,
												_List_Nil,
												A2($elm$core$List$map, $author$project$Main$trainToSvg, model.state.trains))
											]))
									]))
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Main$trainList(model.state.trains)
									])),
								A2(
								$rundis$elm_bootstrap$Bootstrap$Grid$col,
								_List_Nil,
									...
									[
										...
										_List_fromArray(
											[
												...
												$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Main$Stop)
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												$rundis$elm_bootstrap$Bootstrap$Button$primary,
												$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Main$Start)
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												...
												model.isRunning ? $rundis$elm_bootstrap$Bootstrap$Button$disabled(true) : $rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Main$Reset)
											]),
										_List_fromArray(
											[
