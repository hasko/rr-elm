...
{
	if (region.bT.a$ === region.cb.a$)
	{
		return 'on line ' + region.bT.a$;
	}
	return 'on lines ' + region.bT.a$ + ' through ' + region.cb.a$;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dr: 'hidden', dd: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dr: 'mozHidden', dd: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dr: 'msHidden', dd: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dr: 'webkitHidden', dd: 'webkitvisibilitychange' }
		: { dr: 'hidden', dd: 'visibilitychange' };
}
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{A: nodeList, v: (len / $elm$core$Array$branchFactor) | 0, y: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cg: fragment, cl: host, cE: path, cG: port_, cL: protocol, cM: query};
	});
		...
		while (true) {
			...
			if (_Utils_cmp(
				...
				return A2(
					$elm$core$Array$builderToArray,
					true,
					{A: nodeList, v: nodeListSize, y: jsArray});
			} else {
	...
	return _Utils_Tuple2(
		{
			...
			z: {
				df: A2(
					...
					5,
					{
						dv: $ianmackenzie$elm_units$Length$meters(10)
					}),
				aK: $elm$core$Maybe$Just(
					{
						bq: _Utils_Tuple2(0, 1),
						cC: 0,
						cH: $ianmackenzie$elm_units$Length$meters(55.0)
					}),
				cz: 'Happy Train',
				bS: $ianmackenzie$elm_units$Speed$metersPerSecond(10.0)
			}
		},
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {bE: oldTime, cP: request, c0: subs};
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'edges',
				A2($elm$json$Json$Encode$array, $author$project$Railroad$Layout$encodeVertex, _switch.br)),
				_Utils_Tuple2(
				'configs',
				A2(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$drathier$elm_graph$Graph$edgesWithData(layout.X))),
				_Utils_Tuple2(
				'switches',
				A2($elm$json$Json$Encode$array, $author$project$Railroad$Layout$encodeSwitch, layout.bm))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'edge',
				$author$project$Railroad$Layout$encodeVertex(loc.bq)),
				_Utils_Tuple2(
				'pos',
				$elm$json$Json$Encode$float(
					$ianmackenzie$elm_units$Length$inMeters(loc.cH))),
				_Utils_Tuple2(
				'orientation',
				$author$project$Railroad$Orientation$encode(loc.cC))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				'length',
				$elm$json$Json$Encode$float(
					$ianmackenzie$elm_units$Length$inMeters(rs.dv)))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(ts.cz)),
				_Utils_Tuple2(
				'composition',
				A2($elm$json$Json$Encode$list, $author$project$Railroad$Train$encodeRollingStock, ts.df)),
				_Utils_Tuple2(
				'speed',
				$elm$json$Json$Encode$float(
					$ianmackenzie$elm_units$Speed$inMetersPerSecond(ts.bS))),
				_Utils_Tuple2(
				'loc',
				function () {
					var _v0 = ts.aK;
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'layout',
				$author$project$Railroad$Layout$encode(model.J)),
				_Utils_Tuple2(
				'trains',
				A2(
					$elm$json$Json$Encode$list,
				...
				_Utils_Tuple2(
				'switchStates',
				A2($elm$json$Json$Encode$array, $elm$json$Json$Encode$int, model.G))
			]));
};
...
var $author$project$Railroad$Train$Train = F4(
	function (name, composition, speed, location) {
		return {df: composition, aK: location, cz: name, bS: speed};
	});
...
var $author$project$Railroad$Layout$Location = F3(
	function (edge, pos, orientation) {
		return {bq: edge, cC: orientation, cH: pos};
	});
...
var $author$project$Main$modelDecoder = A2(
	...
	function (m) {
		return (!_Utils_eq(
			$elm$core$Array$length(m.G),
			$elm$core$Array$length(m.J.bm))) ? $elm$json$Json$Decode$fail('Incorrect number of switch states') : $elm$json$Json$Decode$succeed(m);
	},
	A4(
		$elm$json$Json$Decode$map3,
		F3(
...
var $author$project$Railroad$Switch$activeEdges = F2(
	function (_switch, state) {
		var _v0 = A2($elm$core$Array$get, state, _switch.bo);
		if (_v0.$ === 1) {
			return _List_Nil;
		} else {
			var edgeIds = _v0.a;
			return $elm_community$maybe_extra$Maybe$Extra$values(
				A2(
					$elm$core$List$map,
					function (eid) {
						return A2($elm$core$Array$get, eid, _switch.br);
					},
					edgeIds));
		}
	});
...
var $author$project$Railroad$Switch$inactiveEdges = F2(
	function (_switch, state) {
		...
		return A2(
			...
			$elm$core$Array$toList(_switch.br));
	});
						...
						function (switchId, switchState) {
							return A2(
								...
								A2(
									...
									A2($elm$core$Array$get, switchId, layout.bm)));
						}),
					switchStates)));
		return A3(
			$elm$core$List$foldl,
			...
			while (true) {
				if (!_v3.a.$) {
					if (_v3.b.$ === 1) {
						...
						return $elm$core$Maybe$Just(
							{
								bq: _Utils_Tuple2(f, t),
								cC: 0,
								cH: $author$project$Railroad$Track$length(e)
							});
					} else {
						break _v3$2;
					}
						...
						return $elm$core$Maybe$Just(
							{
								bq: _Utils_Tuple2(f, t),
								cC: 1,
								cH: $ianmackenzie$elm_units$Quantity$zero
							});
					} else {
						break _v3$2;
					}
...
var $author$project$Railroad$Layout$nextTrack = F3(
	function (loc, layout, switchStates) {
		var iLoc = _Utils_update(
			loc,
			{
				cC: $author$project$Railroad$Orientation$invert(loc.cC)
			});
		return A2(
			$elm$core$Maybe$map,
			function (l) {
				return _Utils_update(
					l,
					{
						cC: $author$project$Railroad$Orientation$invert(l.cC)
					});
			},
...
var $author$project$Railroad$Layout$trackAt = F2(
	function (_v0, layout) {
		var from = _v0.a;
		var to = _v0.b;
		return A3($drathier$elm_graph$Graph$getEdgeData, from, to, layout.X);
	});
var $author$project$Railroad$Train$normalizeLocation = F3(
	function (layout, switchState, loc) {
		var _v0 = A2($author$project$Railroad$Layout$trackAt, loc.bq, layout);
		if (!_v0.$) {
			var track = _v0.a;
			if (A2(
				...
				if ($ianmackenzie$elm_units$Quantity$lessThanZero(loc.cH)) {
					return A2(
						$elm$core$Maybe$andThen,
						function (nextLoc) {
							var _v2 = A2($author$project$Railroad$Layout$trackAt, nextLoc.bq, layout);
							if (_v2.$ === 1) {
								return $elm$core$Maybe$Nothing;
							} else {
								var nt = _v2.a;
...
var $author$project$Railroad$Train$move = F4(
	function (delta, trainState, layout, switchState) {
		...
		if (_v0.$ === 1) {
			...
			var loc = _v0.a;
			var distanceTraveled = A2($ianmackenzie$elm_units$Quantity$for, delta, trainState.bS);
			var newPos = function () {
				var _v1 = loc.cC;
				if (!_v1) {
					return A2($ianmackenzie$elm_units$Quantity$plus, distanceTraveled, loc.cH);
				} else {
					return A2($ianmackenzie$elm_units$Quantity$minus, distanceTraveled, loc.cH);
				}
			}();
			return _Utils_update(
				trainState,
...
var $author$project$Railroad$Train$stopped = function (ts) {
	return _Utils_update(
		ts,
		{bS: $ianmackenzie$elm_units$Quantity$zero});
};
...
var $author$project$Railroad$Layout$tracksAhead = F4(
	function (loc, cutoff, layout, switchStates) {
		...
		if (_v0.$ === 1) {
			...
			var res = _Utils_Tuple3(loc.bq.a, loc.bq.b, currentTrack);
			var newCutoff = function () {
				...
				if (!_v2) {
					...
					return A2($ianmackenzie$elm_units$Quantity$minus, loc.cH, cutoff);
				}
			}();
...
var $author$project$Main$updateTick = F2(
	function (delta, model) {
		var newTrainState = A4($author$project$Railroad$Train$move, delta, model.z, model.J, model.G);
		...
		if (_v0.$ === 1) {
			return _Utils_update(
				...
				{
					W: false,
					z: $author$project$Railroad$Train$stopped(model.z)
				});
		} else {
			var loc = _v0.a;
			var invisible = A2(
		...
		switch (msg.$) {
			...
			case 4:
				...
				var newCfg = A2(
					...
					$elm$core$Array$length(_switch.bo),
					A2(
						$elm$core$Maybe$withDefault,
						0,
						A2($elm$core$Array$get, i, model.G)) + 1);
				var newState = A3($elm$core$Array$set, i, newCfg, model.G);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{G: newState}),
...
var $ianmackenzie$elm_geometry$Direction2d$positiveX = {bZ: 1, b_: 0};
var $ianmackenzie$elm_geometry$Direction2d$x = $ianmackenzie$elm_geometry$Direction2d$positiveX;
var $ianmackenzie$elm_geometry$Direction2d$positiveY = {bZ: 0, b_: 1};
				...
				return $elm_community$intdict$IntDict$Inner(
					{
						...
						k: p,
						f: r,
						bR: $elm_community$intdict$IntDict$size(l) + $elm_community$intdict$IntDict$size(r)
					});
			}
		}
	});
...
var $elm_community$intdict$IntDict$update = F3(
	function (key, alter, dict) {
		...
		switch (dict.$) {
			...
			case 1:
				var l = dict.a;
				return _Utils_eq(l.cp, key) ? alteredNode(
					$elm$core$Maybe$Just(l.ae)) : A2(
					join,
					_Utils_Tuple2(
						key,
						alteredNode($elm$core$Maybe$Nothing)),
					_Utils_Tuple2(l.cp, dict));
			default:
				var i = dict.a;
	...
	function (key, dict) {
		...
		while (true) {
			switch (dict.$) {
				...
				case 1:
					var l = dict.a;
					return _Utils_eq(l.cp, key) ? $elm$core$Maybe$Just(l.ae) : $elm$core$Maybe$Nothing;
				default:
					var i = dict.a;
...
var $ianmackenzie$elm_geometry$Point2d$origin = {bZ: 0, b_: 0};
...
var $ianmackenzie$elm_geometry$Vector2d$direction = function (_v0) {
	...
	var largestComponent = A2(
		$elm$core$Basics$max,
		$elm$core$Basics$abs(v.bZ),
		$elm$core$Basics$abs(v.b_));
	if (!largestComponent) {
		return $elm$core$Maybe$Nothing;
	} else {
		var scaledY = v.b_ / largestComponent;
		var scaledX = v.bZ / largestComponent;
		var scaledLength = $elm$core$Basics$sqrt((scaledX * scaledX) + (scaledY * scaledY));
		return $elm$core$Maybe$Just(
			{bZ: scaledX / scaledLength, b_: scaledY / scaledLength});
	}
};
...
var $ianmackenzie$elm_geometry$Vector2d$from = F2(
	function (_v0, _v1) {
		var p1 = _v0;
		var p2 = _v1;
		return {bZ: p2.bZ - p1.bZ, b_: p2.b_ - p1.b_};
	});
...
var $ianmackenzie$elm_geometry$Direction2d$placeIn = F2(
	function (_v0, _v1) {
		...
		var _v3 = frame.h;
		var dx = _v3;
		return {bZ: (d.bZ * dx.bZ) + (d.b_ * dy.bZ), b_: (d.bZ * dx.b_) + (d.b_ * dy.b_)};
	});
var $ianmackenzie$elm_geometry$Point2d$placeIn = F2(
	function (_v0, _v1) {
		...
		var _v4 = frame.h;
		var i = _v4;
		return {bZ: (p0.bZ + (p.bZ * i.bZ)) + (p.b_ * j.bZ), b_: (p0.b_ + (p.bZ * i.b_)) + (p.b_ * j.b_)};
	});
var $ianmackenzie$elm_geometry$Direction2d$reverse = function (_v0) {
	var d = _v0;
	return {bZ: -d.bZ, b_: -d.b_};
};
...
var $ianmackenzie$elm_geometry$Direction2d$rotateBy = F2(
	function (_v0, _v1) {
		...
		return {bZ: (c * d.bZ) - (s * d.b_), b_: (s * d.bZ) + (c * d.b_)};
	});
...
var $ianmackenzie$elm_geometry$Point2d$translateBy = F2(
	function (_v0, _v1) {
		var v = _v0;
		var p = _v1;
		return {bZ: p.bZ + v.bZ, b_: p.b_ + v.b_};
	});
...
var $ianmackenzie$elm_geometry$Direction2d$toAngle = function (_v0) {
	var d = _v0;
	return A2($elm$core$Basics$atan2, d.b_, d.bZ);
};
		...
		return A2($elm_community$intdict$IntDict$member, nodeId, knownFrames) ? knownFrames : A3(
			...
			F2(
				function (nextNodeId, acc) {
					var _v0 = A3($drathier$elm_graph$Graph$getEdgeData, nodeId, nextNodeId, layout.X);
					if (_v0.$ === 1) {
						return acc;
					} else {
						var track = _v0.a;
			...
			A2($drathier$elm_graph$Graph$outgoing, nodeId, layout.X));
	});
		...
		F2(
			function (c, _v0) {
				...
				return A4(
					...
					A2($elm$core$Basics$min, x1, c.bZ),
					A2($elm$core$Basics$min, y1, c.b_),
					A2($elm$core$Basics$max, x2, c.bZ),
					A2($elm$core$Basics$max, y2, c.b_));
			}),
									...
									!$elm$core$Set$isEmpty(
										A2(
											...
											$elm$core$Set$fromList(
												$elm$core$Array$toList(sw.br)))));
							}),
						$elm$core$Array$toList(layout.bm)))));
	});
...
var $ianmackenzie$elm_geometry_svg$Geometry$Svg$arc2d = F2(
	function (attributes, arc) {
		...
		var moveCommand = _List_fromArray(
			[
				'M',
				$elm$core$String$fromFloat(p0.bZ),
...
var $ianmackenzie$elm_geometry$Direction2d$fromAngle = function (_v0) {
	var angle = _v0;
	return {
		bZ: $elm$core$Basics$cos(angle),
		b_: $elm$core$Basics$sin(angle)
	};
};
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromFloat(cc1.bZ)),
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								'translate(' + ($elm$core$String$fromFloat(refP.bZ) + (',' + ($elm$core$String$fromFloat(refP.b_) + (') rotate(' + ($elm$core$String$fromFloat(refA) + ')'))))))
							]),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$String$fromFloat(p1.bZ)),
					$elm$svg$Svg$Attributes$y1(
					$elm$core$String$fromFloat(p1.b_)),
					$elm$svg$Svg$Attributes$x2(
					$elm$core$String$fromFloat(p2.bZ)),
					$elm$svg$Svg$Attributes$y2(
...
var $author$project$Railroad$Layout$coordsFor = F3(
	function (pos, _v0, layout) {
		...
		return A2(
			...
			A3($drathier$elm_graph$Graph$getEdgeData, fromNode, toNode, layout.X));
	});
...
var $ianmackenzie$elm_geometry$Point2d$distanceFrom = F2(
	function (_v0, _v1) {
		var p1 = _v0;
		var p2 = _v1;
		var deltaY = p2.b_ - p1.b_;
		var deltaX = p2.bZ - p1.bZ;
		var largestComponent = A2(
			$elm$core$Basics$max,
					...
					function (loc) {
						return A2(
							...
							A2(
								$elm$core$Maybe$map,
								$ianmackenzie$elm_geometry$Frame2d$originPoint,
								A3($author$project$Railroad$Layout$coordsFor, loc.cH, loc.bq, layout)));
					},
					A3(
						$author$project$Railroad$Train$normalizeLocation,
						layout,
						...
						_Utils_update(
							startLoc,
							{
								cH: A2(
									$ianmackenzie$elm_units$Quantity$minus,
									correction,
									A2($ianmackenzie$elm_units$Quantity$minus, l, startLoc.cH))
							})));
			},
			A2(
				$elm$core$Maybe$map,
				$ianmackenzie$elm_geometry$Frame2d$originPoint,
				A3($author$project$Railroad$Layout$coordsFor, startLoc.cH, startLoc.bq, layout)));
	});
				...
				A3(
					...
					F2(
						function (car, _v1) {
							...
							var svg = _v1.b;
							var maybeTrack1 = A2($author$project$Railroad$Layout$trackAt, currentLoc.bq, layout);
							var _v2 = A3($author$project$Railroad$Layout$coordsFor, currentLoc.cH, currentLoc.bq, layout);
							if (_v2.$ === 1) {
								return _Utils_Tuple2(currentLoc, svg);
							} else {
								var c1 = _v2.a;
								var _v3 = A4($author$project$Railroad$Train$endLocation, car.dv, layout, switchState, currentLoc);
								if (_v3.$ === 1) {
									return _Utils_Tuple2(currentLoc, svg);
								} else {
									var trainEndLocation = _v3.a;
									var maybeTrack2 = A2($author$project$Railroad$Layout$trackAt, trainEndLocation.bq, layout);
									var _v4 = A3($author$project$Railroad$Layout$coordsFor, trainEndLocation.cH, trainEndLocation.bq, layout);
									if (_v4.$ === 1) {
										return _Utils_Tuple2(currentLoc, svg);
									} else {
										var c2 = _v4.a;
										...
										if ((((!_v5.a.$) && (_v5.a.a.$ === 2)) && (!_v5.b.$)) && (_v5.b.a.$ === 2)) {
											var _v6 = _v5.a.a;
											var _v7 = _v5.b.a;
											return _Utils_eq(currentLoc.bq, trainEndLocation.bq) ? _Utils_Tuple2(trainEndLocation, svg) : _Utils_Tuple2(
												trainEndLocation,
												A2(
													$elm$core$List$cons,
						...
						[
							...
							$elm$core$Array$toList(
								A2(
									...
									A2(
										$elm$core$Array$map,
										$author$project$Main$viewSwitchRoutes(_switch.br),
										_switch.bo))))
						])),
					A2(
					$elm$html$Html$td,
					...
					_List_fromArray(
						[
							...
							if (_v0.$ === 1) {
								...
								var cfg = _v0.a;
								return A2($author$project$Main$viewSwitchRoutes, _switch.br, cfg);
							}
						}()
						])),
					A2(
					...
					[
						...
						$author$project$Rect$rectToString(
							A2(
								...
								5,
								$author$project$Railroad$Layout$boundingBox(model.J))))
					]),
				_List_fromArray(
					[
						A3($elm$html$Html$Lazy$lazy2, $author$project$Railroad$Layout$toSvg, model.J, model.G),
						A2(
						$elm$svg$Svg$g,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								A3($author$project$Railroad$Train$Svg$toSvg, model.z, model.J, model.G)
							]))
					])),
				A2(
				$elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								model.G,
								A3(
									$author$project$Main$getBlockedSwitches,
									model.J,
									model.G,
									_List_fromArray(
										[model.z])))
													...
													[
														...
														_List_fromArray(
															[
																...
																$elm$core$String$fromFloat(
																	$ianmackenzie$elm_units$Length$inMeters(
																		$author$project$Railroad$Train$length(model.z))) + ' m')
															]))
													])),
												A2(
												$elm$html$Html$tr,
													...
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																$elm$core$String$fromFloat(
																	$ianmackenzie$elm_units$Speed$inMetersPerSecond(model.z.bS)) + (' m/s (' + (A2(
																	$myrho$elm_round$Round$round,
																	1,
																	$ianmackenzie$elm_units$Speed$inKilometersPerHour(model.z.bS)) + ' km/h)')))
															]))
													])),
												A2(
												$elm$html$Html$tr,
														...
														function () {
															...
															if (_v0.$ === 1) {
																...
																return _List_fromArray(
																	[
																		$elm$html$Html$text(
																		'edge (' + ($elm$core$String$fromInt(loc.bq.a) + (', ' + ($elm$core$String$fromInt(loc.bq.b) + ')')))),
																			...
																			A2(
																				...
																				function (loc) {
																					return A4(
																						$author$project$Railroad$Layout$tracksBefore,
																						loc,
																						$author$project$Railroad$Train$length(model.z),
																						model.J,
																						model.G);
																				},
																				model.z.aK)))))
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{dt: $author$project$Main$init, dT: $author$project$Main$subscriptions, dX: $author$project$Main$update, dY: $author$project$Main$view});
