...
var $author$project$Railroad$Orientation$Aligned = {$: 'Aligned'};
var $author$project$Railroad$Track$StraightTrack = function (a) {
	return {$: 'StraightTrack', a: a};
};
	...
	return _Utils_Tuple2(
		{
			...
			switchState: A2(
				...
				$elm$core$Array$length(l.switches),
				0),
			trains: _List_fromArray(
				[
					...
					composition: A2(
						...
						5,
						{
							length: $ianmackenzie$elm_units$Length$meters(10)
						}),
					location: $elm$core$Maybe$Just(
						{
							edge: _Utils_Tuple2(0, 1),
							orientation: $author$project$Railroad$Orientation$Aligned,
							pos: $ianmackenzie$elm_units$Length$meters(55.0)
						}),
					name: 'Happy Train',
					speed: $ianmackenzie$elm_units$Speed$kilometersPerHour(40.0)
				}
				])
		},
		$elm$core$Platform$Cmd$none);
...
var $author$project$Main$subscriptions = function (model) {
	return model.running ? $elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Main$Tick) : $author$project$Main$layoutReceiver($author$project$Main$LayoutReceived);
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'edges',
				A2($elm$json$Json$Encode$array, $author$project$Railroad$Layout$encodeVertex, _switch.edges)),
				_Utils_Tuple2(
				'configs',
				A2(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$drathier$elm_graph$Graph$edgesWithData(layout.graph))),
				_Utils_Tuple2(
				'switches',
				A2($elm$json$Json$Encode$array, $author$project$Railroad$Layout$encodeSwitch, layout.switches))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'edge',
				$author$project$Railroad$Layout$encodeVertex(loc.edge)),
				_Utils_Tuple2(
				'pos',
				$elm$json$Json$Encode$float(
					$ianmackenzie$elm_units$Length$inMeters(loc.pos))),
				_Utils_Tuple2(
				'orientation',
				$author$project$Railroad$Orientation$encode(loc.orientation))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				'length',
				$elm$json$Json$Encode$float(
					$ianmackenzie$elm_units$Length$inMeters(rs.length)))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(ts.name)),
				_Utils_Tuple2(
				'composition',
				A2($elm$json$Json$Encode$list, $author$project$Railroad$Train$encodeRollingStock, ts.composition)),
				_Utils_Tuple2(
				'speed',
				$elm$json$Json$Encode$float(
					$ianmackenzie$elm_units$Speed$inMetersPerSecond(ts.speed))),
				_Utils_Tuple2(
				'loc',
				function () {
					var _v0 = ts.location;
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'layout',
				$author$project$Railroad$Layout$encode(model.layout)),
				_Utils_Tuple2(
				'trains',
				A2($elm$json$Json$Encode$list, $author$project$Railroad$Train$encode, model.trains)),
				_Utils_Tuple2(
				'switchStates',
				A2($elm$json$Json$Encode$array, $elm$json$Json$Encode$int, model.switchState))
			]));
};
...
var $author$project$Railroad$Layout$decoder = $elm$json$Json$Decode$succeed(
	{graph: $drathier$elm_graph$Graph$empty, switches: $elm$core$Array$empty});
var $author$project$Railroad$Train$Train = F4(
	function (name, composition, speed, location) {
		return {composition: composition, location: location, name: name, speed: speed};
	});
var $author$project$Railroad$Layout$Location = F3(
	function (edge, pos, orientation) {
		return {edge: edge, orientation: orientation, pos: pos};
	});
...
var $author$project$Railroad$Layout$orientationDecoder = A2(
	...
	function (s) {
		if (s === 'aligned') {
			return $elm$json$Json$Decode$succeed($author$project$Railroad$Orientation$Aligned);
		} else {
...
var $author$project$Main$modelDecoder = A2(
	...
	function (m) {
		return (!_Utils_eq(
			$elm$core$Array$length(m.switchState),
			$elm$core$Array$length(m.layout.switches))) ? $elm$json$Json$Decode$fail('Incorrect number of switch states') : $elm$json$Json$Decode$succeed(m);
	},
	A4(
		$elm$json$Json$Decode$map3,
		F3(
			function (ts, l, sws) {
				return {
					deltas: _List_Nil,
					flash: $elm$core$Maybe$Just('Loaded successfully'),
					layout: l,
					running: false,
					switchState: sws,
					trains: ts
...
var $author$project$Railroad$Orientation$Reversed = {$: 'Reversed'};
var $author$project$Railroad$Orientation$invert = function (o) {
	if (o.$ === 'Aligned') {
		return $author$project$Railroad$Orientation$Reversed;
	} else {
		return $author$project$Railroad$Orientation$Aligned;
	}
};
...
var $author$project$Railroad$Switch$activeEdges = F2(
	function (_switch, state) {
		var _v0 = A2($elm$core$Array$get, state, _switch.configs);
		if (_v0.$ === 'Nothing') {
			return _List_Nil;
		} else {
			var edgeIds = _v0.a;
			return $elm_community$maybe_extra$Maybe$Extra$values(
				A2(
					$elm$core$List$map,
					function (eid) {
						return A2($elm$core$Array$get, eid, _switch.edges);
					},
					edgeIds));
		}
	});
...
var $author$project$Railroad$Switch$inactiveEdges = F2(
	function (_switch, state) {
		...
		return A2(
			...
			$elm$core$Array$toList(_switch.edges));
	});
						...
						function (switchId, switchState) {
							return A2(
								...
								A2(
									...
									A2($elm$core$Array$get, switchId, layout.switches)));
						}),
					switchStates)));
		return A3(
			$elm$core$List$foldl,
			...
			while (true) {
				if (_v3.a.$ === 'Just') {
					if (_v3.b.$ === 'Nothing') {
						...
						return $elm$core$Maybe$Just(
							{
								edge: _Utils_Tuple2(f, t),
								orientation: $author$project$Railroad$Orientation$Aligned,
								pos: $author$project$Railroad$Track$length(e)
							});
					} else {
						break _v3$2;
					}
					...
					if (_v3.b.$ === 'Just') {
						...
						return $elm$core$Maybe$Just(
							{
								edge: _Utils_Tuple2(f, t),
								orientation: $author$project$Railroad$Orientation$Reversed,
								pos: $ianmackenzie$elm_units$Quantity$zero
							});
					} else {
						break _v3$2;
					}
...
var $author$project$Railroad$Layout$nextTrack = F3(
	function (loc, layout, switchStates) {
		var iLoc = _Utils_update(
			loc,
			{
				orientation: $author$project$Railroad$Orientation$invert(loc.orientation)
			});
		return A2(
			$elm$core$Maybe$map,
			function (l) {
				return _Utils_update(
					l,
					{
						orientation: $author$project$Railroad$Orientation$invert(l.orientation)
					});
			},
	...
	function (from, to, graph) {
		return $elm_community$maybe_extra$Maybe$Extra$join(
			A2(
				...
				function (_v0) {
					var node = _v0.a;
					return A2($elm$core$Dict$get, to, node.outgoing);
				},
...
var $author$project$Railroad$Layout$trackAt = F2(
	function (_v0, layout) {
		var from = _v0.a;
		var to = _v0.b;
		return A3($drathier$elm_graph$Graph$getEdgeData, from, to, layout.graph);
	});
var $author$project$Railroad$Train$normalizeLocation = F3(
	function (layout, switchState, loc) {
		var _v0 = A2($author$project$Railroad$Layout$trackAt, loc.edge, layout);
		if (_v0.$ === 'Just') {
			var track = _v0.a;
			if (A2(
				...
				if ($ianmackenzie$elm_units$Quantity$lessThanZero(loc.pos)) {
					return A2(
						$elm$core$Maybe$andThen,
						function (nextLoc) {
							var _v2 = A2($author$project$Railroad$Layout$trackAt, nextLoc.edge, layout);
							if (_v2.$ === 'Nothing') {
								return $elm$core$Maybe$Nothing;
							} else {
								var nt = _v2.a;
...
var $author$project$Railroad$Train$move = F4(
	function (delta, trainState, layout, switchState) {
		var _v0 = trainState.location;
		if (_v0.$ === 'Nothing') {
			return trainState;
		} else {
			var loc = _v0.a;
			var distanceTraveled = A2($ianmackenzie$elm_units$Quantity$for, delta, trainState.speed);
			var newPos = function () {
				var _v1 = loc.orientation;
				if (_v1.$ === 'Aligned') {
					return A2($ianmackenzie$elm_units$Quantity$plus, distanceTraveled, loc.pos);
				} else {
					return A2($ianmackenzie$elm_units$Quantity$minus, distanceTraveled, loc.pos);
				}
			}();
			return _Utils_update(
				trainState,
...
var $author$project$Railroad$Train$stopped = function (ts) {
	return _Utils_update(
		ts,
		{speed: $ianmackenzie$elm_units$Quantity$zero});
};
...
var $author$project$Railroad$Layout$tracksAhead = F4(
	function (loc, cutoff, layout, switchStates) {
		...
		if (_v0.$ === 'Nothing') {
			...
			var res = _Utils_Tuple3(loc.edge.a, loc.edge.b, currentTrack);
			var newCutoff = function () {
				...
				if (_v2.$ === 'Aligned') {
					...
					return A2($ianmackenzie$elm_units$Quantity$minus, loc.pos, cutoff);
				}
			}();
...
var $author$project$Main$updateTick = F2(
	function (delta, model) {
		var newTrainStates = A2(
			$elm$core$List$map,
			function (train) {
				var newTrainState = A4($author$project$Railroad$Train$move, delta, train, model.layout, model.switchState);
				var _v0 = newTrainState.location;
				if (_v0.$ === 'Nothing') {
					...
					return invisible ? _Utils_update(
						newTrainState,
						{location: $elm$core$Maybe$Nothing}) : newTrainState;
				}
			},
			model.trains);
		return _Utils_update(
			model,
			{
				running: A2(
					$elm$core$List$any,
					function (train) {
						return $ianmackenzie$elm_units$Quantity$greaterThanZero(train.speed);
					},
					newTrainStates),
		...
		switch (msg.$) {
						...
						_Utils_update(
							model,
							{
								deltas: A2(
									$elm$core$List$take,
									100,
									A2($elm$core$List$cons, d, model.deltas))
							})),
					$elm$core$Platform$Cmd$none);
			case 'Toggle':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'Step':
				return model.running ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
			...
			case 'ChangeSwitch':
				...
				var newCfg = A2(
					...
					$elm$core$Array$length(_switch.configs),
					A2(
						$elm$core$Maybe$withDefault,
						0,
						A2($elm$core$Array$get, i, model.switchState)) + 1);
				var newState = A3($elm$core$Array$set, i, newCfg, model.switchState);
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $ianmackenzie$elm_geometry$Frame2d$isRightHanded = function (_v0) {
	var frame = _v0.a;
	var y2 = $ianmackenzie$elm_geometry$Direction2d$yComponent(frame.yDirection);
	var y1 = $ianmackenzie$elm_geometry$Direction2d$yComponent(frame.xDirection);
	var x2 = $ianmackenzie$elm_geometry$Direction2d$xComponent(frame.yDirection);
	var x1 = $ianmackenzie$elm_geometry$Direction2d$xComponent(frame.xDirection);
...
var $ianmackenzie$elm_geometry$Arc2d$placeIn = F2(
	function (frame, _v0) {
		var arc = _v0.a;
		return $ianmackenzie$elm_geometry$Frame2d$isRightHanded(frame) ? $ianmackenzie$elm_geometry$Geometry$Types$Arc2d(
			{
				signedLength: arc.signedLength,
				startPoint: A2($ianmackenzie$elm_geometry$Point2d$placeIn, frame, arc.startPoint),
				sweptAngle: arc.sweptAngle,
				xDirection: A2($ianmackenzie$elm_geometry$Direction2d$placeIn, frame, arc.xDirection)
			}) : $ianmackenzie$elm_geometry$Geometry$Types$Arc2d(
			{
				signedLength: $ianmackenzie$elm_units$Quantity$negate(arc.signedLength),
				startPoint: A2($ianmackenzie$elm_geometry$Point2d$placeIn, frame, arc.startPoint),
				sweptAngle: $ianmackenzie$elm_units$Quantity$negate(arc.sweptAngle),
				xDirection: $ianmackenzie$elm_geometry$Direction2d$reverse(
					A2($ianmackenzie$elm_geometry$Direction2d$placeIn, frame, arc.xDirection))
			});
	});
...
var $author$project$Railroad$Track$CurvedTrack = F2(
	function (a, b) {
		return {$: 'CurvedTrack', a: a, b: b};
	});
var $author$project$Railroad$Track$moveFrameReverse = F2(
	function (frame, track) {
		switch (track.$) {
			case 'StraightTrack':
				var l = track.a;
				return A2($author$project$Railroad$Track$moveFrame, frame, track);
			case 'CurvedTrack':
				var r = track.a;
				var a = track.b;
				return A2(
					$author$project$Railroad$Track$moveFrame,
					frame,
					A2(
						$author$project$Railroad$Track$CurvedTrack,
						r,
						$ianmackenzie$elm_units$Quantity$negate(a)));
			default:
				return frame;
		}
	});
var $author$project$Railroad$Layout$renderEdge = F2(
	function (_v0, frames) {
		var from = _v0.a;
		var to = _v0.b;
		var maybeTrack = _v0.c;
		var mf2 = A2($elm_community$intdict$IntDict$get, to, frames);
		var mf1 = A2($elm_community$intdict$IntDict$get, from, frames);
		var _v1 = _Utils_Tuple3(mf1, mf2, maybeTrack);
		if (_v1.c.$ === 'Nothing') {
			var _v2 = _v1.c;
			return frames;
		} else {
			if (_v1.a.$ === 'Just') {
				if (_v1.b.$ === 'Just') {
					...
					return A3(
						...
						to,
						A2($author$project$Railroad$Track$moveFrame, f1, t),
						frames);
				}
			} else {
				if (_v1.b.$ === 'Nothing') {
					...
					return A3(
						$elm_community$intdict$IntDict$insert,
						from,
						A2($author$project$Railroad$Track$moveFrameReverse, f2, t),
						frames);
				}
			}
		}
	});
var $author$project$Railroad$Layout$renderLayout = F2(
	function (layout, frames) {
		...
		while (true) {
			var newFrames = A3(
				$elm$core$List$foldl,
				F2(
					function (edge, result) {
						return A2($author$project$Railroad$Layout$renderEdge, edge, result);
					}),
				frames,
				$drathier$elm_graph$Graph$edgesWithData(layout.graph));
			var c2 = $elm$core$List$length(
				$elm_community$intdict$IntDict$keys(newFrames));
			var c1 = $elm$core$List$length(
				$elm_community$intdict$IntDict$keys(frames));
			if (_Utils_cmp(c2, c1) > 0) {
				var $temp$layout = layout,
					$temp$frames = newFrames;
				layout = $temp$layout;
				frames = $temp$frames;
				continue renderLayout;
			} else {
				return newFrames;
			}
		}
...
var $author$project$Railroad$Layout$cursors = function (layout) {
	return A2(
		...
		layout,
		A2($elm_community$intdict$IntDict$singleton, 0, $ianmackenzie$elm_geometry$Frame2d$atOrigin));
};
		...
		F2(
			function (c, _v0) {
				...
				return A4(
					...
					A2($elm$core$Basics$min, x1, c.x),
					A2($elm$core$Basics$min, y1, c.y),
					A2($elm$core$Basics$max, x2, c.x),
					A2($elm$core$Basics$max, y2, c.y));
			}),
									...
									!$elm$core$Set$isEmpty(
										A2(
											...
											$elm$core$Set$fromList(
												$elm$core$Array$toList(sw.edges)))));
							}),
						$elm$core$Array$toList(layout.switches)))));
	});
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromFloat(cc1.x)),
								$elm$svg$Svg$Attributes$y2(
								$elm$core$String$fromFloat(cc1.y)),
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								'translate(' + ($elm$core$String$fromFloat(refP.x) + (',' + ($elm$core$String$fromFloat(refP.y) + (') rotate(' + ($elm$core$String$fromFloat(refA) + ')'))))))
							]),
...
var $author$project$Railroad$Layout$coordsFor = F3(
	function (pos, _v0, layout) {
		...
		return A2(
			...
			A3($drathier$elm_graph$Graph$getEdgeData, fromNode, toNode, layout.graph));
	});
					...
					function (loc) {
						return A2(
							...
							A2(
								$elm$core$Maybe$map,
								$ianmackenzie$elm_geometry$Frame2d$originPoint,
								A3($author$project$Railroad$Layout$coordsFor, loc.pos, loc.edge, layout)));
					},
					A3(
						$author$project$Railroad$Train$normalizeLocation,
						layout,
						...
						_Utils_update(
							startLoc,
							{
								pos: A2(
									$ianmackenzie$elm_units$Quantity$minus,
									correction,
									A2($ianmackenzie$elm_units$Quantity$minus, l, startLoc.pos))
							})));
			},
			A2(
				$elm$core$Maybe$map,
				$ianmackenzie$elm_geometry$Frame2d$originPoint,
				A3($author$project$Railroad$Layout$coordsFor, startLoc.pos, startLoc.edge, layout)));
	});
				...
				A3(
					...
					F2(
						function (car, _v1) {
							...
							var svg = _v1.b;
							var maybeTrack1 = A2($author$project$Railroad$Layout$trackAt, currentLoc.edge, layout);
							var _v2 = A3($author$project$Railroad$Layout$coordsFor, currentLoc.pos, currentLoc.edge, layout);
							if (_v2.$ === 'Nothing') {
								return _Utils_Tuple2(currentLoc, svg);
							} else {
								var c1 = _v2.a;
								var _v3 = A4($author$project$Railroad$Train$endLocation, car.length, layout, switchState, currentLoc);
								if (_v3.$ === 'Nothing') {
									return _Utils_Tuple2(currentLoc, svg);
								} else {
									var trainEndLocation = _v3.a;
									var maybeTrack2 = A2($author$project$Railroad$Layout$trackAt, trainEndLocation.edge, layout);
									var _v4 = A3($author$project$Railroad$Layout$coordsFor, trainEndLocation.pos, trainEndLocation.edge, layout);
									if (_v4.$ === 'Nothing') {
										return _Utils_Tuple2(currentLoc, svg);
									} else {
										var c2 = _v4.a;
										...
										if ((((_v5.a.$ === 'Just') && (_v5.a.a.$ === 'MapExit')) && (_v5.b.$ === 'Just')) && (_v5.b.a.$ === 'MapExit')) {
											var _v6 = _v5.a.a;
											var _v7 = _v5.b.a;
											return _Utils_eq(currentLoc.edge, trainEndLocation.edge) ? _Utils_Tuple2(trainEndLocation, svg) : _Utils_Tuple2(
												trainEndLocation,
												A2(
													$elm$core$List$cons,
						...
						[
							...
							$elm$core$Array$toList(
								A2(
									...
									A2(
										$elm$core$Array$map,
										$author$project$Main$viewSwitchRoutes(_switch.edges),
										_switch.configs))))
						])),
					A2(
					$elm$html$Html$td,
					...
					_List_fromArray(
						[
							...
							if (_v0.$ === 'Nothing') {
								...
								var cfg = _v0.a;
								return A2($author$project$Main$viewSwitchRoutes, _switch.edges, cfg);
							}
						}()
						])),
					A2(
					...
					[
						...
						$author$project$Rect$rectToString(
							A2(
								...
								5,
								$author$project$Railroad$Layout$boundingBox(model.layout))))
					]),
				_List_fromArray(
					[
						A3($elm$html$Html$Lazy$lazy2, $author$project$Railroad$Layout$toSvg, model.layout, model.switchState),
						A2(
						$elm$svg$Svg$g,
						_List_fromArray(
							[
						...
						A2(
							$elm$core$List$map,
							function (train) {
								return A3($author$project$Railroad$Train$Svg$toSvg, train, model.layout, model.switchState);
							},
							model.trains))
					])),
				A2(
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt(
									$author$project$Main$frameRate(model.deltas)) + ' fps')
							]))
					])),
				A2(
				$elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								model.layout,
								model.switchState,
								A3($author$project$Main$getBlockedSwitches, model.layout, model.switchState, model.trains))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
															...
															_List_fromArray(
																[
																	...
																	A2(
																		...
																		1,
																		$ianmackenzie$elm_units$Speed$inMetersPerSecond(train.speed)) + (' m/s (' + (A2(
																		$myrho$elm_round$Round$round,
																		1,
																		$ianmackenzie$elm_units$Speed$inKilometersPerHour(train.speed)) + ' km/h)')))
																]))
														])),
													A2(
													$elm$html$Html$tr,
															...
															function () {
																...
																if (_v0.$ === 'Nothing') {
																	...
																	return _List_fromArray(
																		[
																			$elm$html$Html$text(
																			'edge (' + ($elm$core$String$fromInt(loc.edge.a) + (', ' + ($elm$core$String$fromInt(loc.edge.b) + ')')))),
																			A2($elm$html$Html$br, _List_Nil, _List_Nil),
																			$elm$html$Html$text(
																			'pos ' + (A2(
																				$myrho$elm_round$Round$round,
																				2,
																				$ianmackenzie$elm_units$Length$inMeters(loc.pos)) + ' m')),
																			A2($elm$html$Html$br, _List_Nil, _List_Nil),
																			$elm$html$Html$text(
																			$author$project$Railroad$Orientation$toString(loc.orientation))
																		]);
																}
															}())
														])),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			...
			])))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Railroad.Switch.Switch":{"args":[],"type":"{ edges : Array.Array ( Basics.Int, Basics.Int ), configs : Array.Array (List.List Basics.Int) }"},"Array.Tree":{"args":["a"],"type":"Elm.JsArray.JsArray (Array.Node a)"}},"unions":{"Main.Msg":{"args":[],"tags":{"Tick":["Basics.Float"],"Toggle":[],"Step":[],"Reset":[],"ChangeSwitch":["Basics.Int","Railroad.Switch.Switch"],"LayoutReceived":["Json.Encode.Value"],"SaveRequested":[]}},"Array.Array":{"args":["a"],"tags":{"Array_elm_builtin":["Basics.Int","Basics.Int","Array.Tree a","Elm.JsArray.JsArray a"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Elm.JsArray.JsArray":{"args":["a"],"tags":{"JsArray":["a"]}},"Array.Node":{"args":["a"],"tags":{"SubTree":["Array.Tree a"],"Leaf":["Elm.JsArray.JsArray a"]}}}}})}});}(this));